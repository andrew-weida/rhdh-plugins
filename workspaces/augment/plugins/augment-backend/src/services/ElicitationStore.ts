 ...
 *
 * When an MCP server requests user input via the elicitation/create protocol,
 * the backend registers a pending promise here. The tool execution coroutine
 * awaits this promise; when the user responds via POST /chat/elicitation/respond,
 * the route handler resolves the promise and tool execution continues.
 */
